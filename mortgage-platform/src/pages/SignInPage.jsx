...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      {/* ── Right form panel ── */}
      <div className="flex-1 flex items-center justify-center px-5 py-10" style={{ background: '#ffffff' }}>
        <div className="w-full max-w-[380px]">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <h1 className="text-2xl font-extrabold mb-1" style={{ color: '#0a0a0a', letterSpacing: '-0.03em' }}>Welcome back</h1>
            <p className="text-sm mb-7" style={{ color: '#888888' }}>Sign in to your account to continue</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <Mail size={14} style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', color: '#cccccc', pointerEvents: 'none' }} />
                  <input
                    type="email"
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  <label className="text-xs font-semibold uppercase tracking-wider" style={{ color: '#888888' }}>Password</label>
                  <Link to="#" className="text-xs font-medium" style={{ color: '#0a0a0a' }}>Forgot password?</Link>
                </div>
                <div style={{ position: 'relative' }}>
                  <Lock size={14} style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', color: '#cccccc', pointerEvents: 'none' }} />
                  <input
                  ...
                  <button type="button" onClick={() => setShowPass(!showPass)}
                    style={{ position: 'absolute', right: 14, top: '50%', transform: 'translateY(-50%)', color: '#cccccc', background: 'none', border: 'none', cursor: 'pointer', padding: 0, display: 'flex' }}>
            ...
            <p className="text-center mt-6 text-sm" style={{ color: '#888888' }}>
              ...
              <Link to="/signup" className="font-semibold" style={{ color: '#0a0a0a' }}>
